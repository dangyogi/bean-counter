...
class row:
    ...
    foreign_keys = ()
    in_database = True
    hidden = frozenset()  # column names that are excluded from report generated by report.py
    abbr = {}             # {col_name: abbr} for report generated by report.py
...
class Items(row):
    ...
    abbr = dict(perishable      = "perish",
                supplier_id     = "supp_id",
                num_per_meal    = "#/meal",
                num_per_table   = "#/table",
                num_per_serving = "#/serving",
               )
...
class Months(row):
   ...
   #hidden = frozenset(("month_str", "meeting_date", "breakfast_date"))
    abbr = dict(num_at_meeting     = "#@mtg",
                staff_at_breakfast = "stf@bf",
                tickets_claimed    = "tkt_clm",
                served_fudge       = "srv_fg",
                consumed_fudge     = "cns_fg",
                meals_served       = "ml_srv",
                month_str          = "mth_str",
                meeting_date       = "mtg_date",
                breakfast_date     = "bf_date",
               )
...
class Starts(row, bills):  # row first, so it's __init__ is used.
    ...
    calculated["type"] = str
    hidden = row.hidden.union(("section", "category", "type"))
...
class Reconcile(Starts):
    ...
    abbr = dict(donations = "don",
                ticket_price = "tkt_prc",
                tickets_sold = "tkts_sold",
               )
